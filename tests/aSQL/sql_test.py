...
def test_get_assignments_in_various_states():
    ...
    with open('tests/aSQL/number_of_assignments_per_state.sql', encoding='utf8') as fo:
        sql = fo.read()
...
def test_get_grade_A_assignments_for_teacher_with_max_grading():
    ...
    with open('tests/aSQL/count_grade_A_assignments_by_teacher_with_max_grading.sql', encoding='utf8') as fo:
        sql = fo.read()
